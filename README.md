# 🌐 Portfolio — วิชาเครือข่ายคอมพิวเตอร์
...
| หมวดหมู่ | ทักษะ |
|---|---|
| **Network Design** | ออกแบบ Topology แบบ P2P, LAN, Internetwork |
| **Cisco IOS CLI** | ตั้งค่า Router, Switch, VLAN, Subinterface, NAT, Static Route |
| **Protocol Analysis** | วิเคราะห์ HTTP, FTP, DNS, SMTP, POP3 ผ่าน Packet Tracer Simulation |
| **TCP vs UDP** | เปรียบเทียบ 3-Way Handshake, Flags (SYN/ACK/PSH/FIN), UDP Header |
| **VLAN & Trunking** | ตั้งค่า 802.1Q, Router-on-a-Stick, Access/Trunk Port |
| **Troubleshooting** | แก้ปัญหา Wrong Subnet, Interface Shutdown, Incorrect Gateway |
| **WAN / Serial Link** | ตั้งค่า Serial Interface, Clock Rate, ISP Domain (100.x.x.x) |
| **IaC / DevOps** | Deploy Mockup Infrastructure ด้วย Podman + Python |
...
## 💡 สิ่งที่ได้เรียนรู้ตลอดภาคการศึกษา

### มุมมองก่อนเรียน
ก่อนเรียนวิชานี้ คิดว่าเครือข่ายคือการเชื่อมต่อสายสัญญาณแล้วข้อมูลก็วิ่งผ่านโดยตรงอย่างง่ายดาย และคาดว่าทุกโปรโตคอลน่าจะมีรูปแบบการทำงานคล้ายๆ กัน

### สิ่งที่เกิดขึ้นจริง
การจำลองสถานการณ์ผ่าน Packet Tracer เปิดเผยความซับซ้อนที่ไม่คาดคิด:

1. **Packet วิ่งไปมาหลายรอบ** — แค่ส่งอีเมลฉบับเดียวมี Packet วิ่งไปกลับเป็นสิบรอบ
2. **HTTP/FTP/Email ต้องคุยกัน 3 รอบก่อน** — TCP Handshake เหมือนการเคาะประตูก่อนเข้า
3. **DNS ส่งคำถามทันที** — UDP ไม่ต้องคุยกันก่อน จึงเร็วกว่ามาก
4. **WAN Serial Link ต้องมี Clock Rate** — เหมือนการนัดจังหวะก่อนส่งข้อมูล ขาดไม่ได้

### ความเข้าใจสำคัญที่ได้
- การเชื่อมต่อในเครือข่ายไม่ใช่แค่ทางกายภาพ แต่เป็น **กระบวนการตกลงกันทางตรรกะ** ระหว่างซอฟต์แวร์ฝั่งผู้ส่งและผู้รับ
- การจำลองผ่าน Packet Tracer ช่วยให้มองเห็นลำดับขั้นตอนการสื่อสารที่ซับซ้อนได้อย่างเป็นรูปธรรม
