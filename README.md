...
- Cisco Packet Tracer Certified ผ่านการทดสอบและได้รับใบประกาศนียบัตรหลักสูตรพื้นฐานจาก Cisco Networking Academy โดยคณะวิทยาศาสตร์ มหาวิทยาลัยขอนแก่น
...
Link : https://drive.google.com/drive/u/3/folders/1IZAFte5lCYznwRec4ghbgVuIpPEPmuom
...
| PC1 Connectivity | `ping 192.168.1.11` | Success (4 replies) (PASS) |
| ARP Resolution | `arp -a` on PC1 | 2+ entries  (PASS) |
| MAC Learning | `show mac address-table` | 2 dynamic entries  (PASS) |
...
Link : https://drive.google.com/drive/folders/1Wxnx-LAd4KSKwy5-uOdzWnxKEmjExQwB?usp=drive_link
...
Link : https://drive.google.com/drive/folders/1bze9bJsukcZExQlEPsAbdVDcoXuD6qkc?usp=drive_link
...
Link : https://docs.google.com/document/d/1g3yDFS_eIdvj7IYw1kJsOH6J4m5yxQn1IEmbosHGN6U/edit?tab=t.0
...
Link : https://drive.google.com/file/d/1cZRbwa-v8TqriHUAmvcD2EewrQ8xrdy3/view?usp=sharing
...
เขียน Essay เกี่ยวกับ Google Maps / GPS ในฐานะตัวอย่างการใช้เครือข่ายในชีวิตจริงของนักศึกษา อธิบายกระบวนการที่เกิดขึ้นตั้งแต่การส่งคำขอผ่านเครือข่ายโทรศัพท์ ผ่าน TCP/IP ไปยัง Server ของ Google และรับเส้นทางกลับมา รวมถึงอธิบายข้อจำกัดเมื่ออยู่ในพื้นที่อับสัญญาณ
